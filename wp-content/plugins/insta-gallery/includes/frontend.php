...
if ( ! class_exists( 'QLIGG_Frontend' ) ) {
	...
	class QLIGG_Frontend {
		...
		function add_js() {
			...
			$frontend = include_once QLIGG_PLUGIN_DIR . 'build/frontend/js/index.asset.php';

			wp_register_style( 'insta-gallery', plugins_url( '/build/frontend/css/style.css', QLIGG_PLUGIN_FILE ), null, QLIGG_PLUGIN_VERSION );

			wp_register_script( 'insta-gallery', plugins_url( '/build/frontend/js/index.js', QLIGG_PLUGIN_FILE ), $frontend['dependencies'], $frontend['version'], true );
